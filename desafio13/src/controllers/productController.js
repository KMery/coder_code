...
const getProducts = async (req, res) => {
    let read_products = await leer(path.join(__dirname, '../public/productos.txt'));
    let read_messages = await leer(path.join(__dirname, '../public/chat.txt'));
